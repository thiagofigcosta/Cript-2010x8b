...
public class FunctionsTests { 
    ...
    static void n() throws HashException{
        ...
        if(jk.compressHash().equals(new Hash(jk.compressHash()).compressHash()))System.out.println("...OK");
        else System.out.println("...fail");
    }
    
    public static void main(String[] args) throws HashException { 
        //TODO: 
        //      verificar compressao do hash (ERRO EM 2 4 16 17)
        //      verificar importacao do hash via string (ERRO EM 2 4 16 17)
        //      fazer show steeps
        //      ativar cript do hash
        n(); 
    }     
} 
