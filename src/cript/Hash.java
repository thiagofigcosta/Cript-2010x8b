...
public class Hash { 
    ...
    public static ExportedHashData searchHash(String data) throws HashException{
        ...
        Hash sHash=new Hash(findedHash);     
                    System.out.println(sHash.showData());
    ...
    public String compressHash(){ 
        ...
        if(!Cript2010x8b.CRIPTHASH)return ""+zero+one+two+three+four+five+six+seven+eight+nine+ten+eleven+twelve+thirteen+fourteen+fifteen+sixteen+seventeen; 
        return hash; 
    } 
