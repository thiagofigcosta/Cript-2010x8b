...
public class Cript { 
    private final static boolean one=Cript2010x8b.CRIPT&&true;//invert e switch
    private final static boolean two=Cript2010x8b.CRIPT&&true;//use AIOBG
    private final static boolean three=Cript2010x8b.CRIPT&&true;//add
    private final static boolean four=Cript2010x8b.CRIPT&&true;//mult pow
    ...
    public String cript() throws MultDivException { 
        ...
        for(int i=1;i<=7;i++){ 
            ...
            if(Cript2010x8b.PRINTSTEEPS) System.out.println("*****Steep: "+i+"/7 ("+steep+")");
            switch(steep){ 
                case 1: if(!one)break;
            ...
            Cript2010x8b.computingSteeps=i;
        } 
        this.cripted=out; 
        return out; 
    } 
