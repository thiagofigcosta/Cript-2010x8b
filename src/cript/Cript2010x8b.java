...
public class Cript2010x8b { 
    ...
    public static final byte VERSION=0b0011; 
    public static final boolean USEPOWNTHRT=false;
    public static final boolean PRINTDIVEXCEPTIONS=true; 
    ...
    public static final boolean CHECKHASHFAIL=true;
    ...
    public Cript2010x8b(int nCript,boolean cript, Hash hash,String data,boolean hashInFile) throws HashException, DataException{ 
    ...
    public Cript2010x8b(int nCript,boolean cript,boolean hashInFile,Hash hash,String path) throws IOException, HashException, DataException { 
        Cript2010x8b.totalSteeps=nCript*7;
        Cript2010x8b.computingSteeps=0;
        Cript2010x8b.currentSteeps=0;
        this.nCript=nCript; 
    ...
    public Cript2010x8b(String command,String path) throws IOException, HashException, DataException{ 
        this.path=path;   
    ...
    public Cript2010x8b(String command,String path,String pathhash) throws IOException, HashException, DataException{ 
        this.path=path;   
        for(int i=0;i<command.length();i++){//TODO: aceitar comando de arquivos tb(nCript\nhash) 
            if(Character.toLowerCase(command.charAt(i))=='c'||Character.toLowerCase(command.charAt(i))=='d'){ 
                if(Character.toLowerCase(command.charAt(i))=='c')this.cript=true; 
    ...
    private void run() throws HashException{
        ...
        if(CHECKDATALOSS&&cript)if(cript)if(!compare())if(PRINT){if(Cript2010x8b.PRINTSTEEPS) System.out.println("***Checking data");System.out.println(hash.showData());}
    } 
